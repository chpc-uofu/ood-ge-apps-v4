...
apptainer run --nv -e -B /scratch/general/vast/u0101881/nim:/opt/nim/.cache --env NGC_API_KEY=$NGC_API_KEY,DOCKER_USERNAME='\$oauthtoken',NIM_SERVER_PORT=$1 /uufs/chpc.utah.edu/sys/installdir/r8/nim/llama-3.2-1b-instruct_1.0.0.sif
